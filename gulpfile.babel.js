...
project.audio = `${project.assets}/audio`;
...
// Copy Audio Assets
function audio() {
	return gulp.src(`${project.audio}/**/*`).pipe(gulp.dest(`${project.dist}/audio`));
}
...
const build = gulp.series(
	clean,
	gulp.parallel(html, css, favicon, audio, images, js, fonts)
);
const watch = gulp.parallel(watchFiles, browserSync);

// export tasks
export { html, images, favicon, audio, fonts, css, js, clean, build, watch };
